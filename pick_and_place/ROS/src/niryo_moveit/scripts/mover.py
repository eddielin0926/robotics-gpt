...
from niryo_moveit.srv import MoverService, MoverServiceRequest, MoverServiceResponse, MoveToPoseService, MoveToPoseServiceRequest, MoveToPoseServiceResponse
...
def moveit_server():
    ...
    #s2 = rospy.Service('niryo_moveit', MoveToPoseService, plan_move_to_pose)
    print("Ready to plan")
    rospy.spin()
